...
def buscar_ids_vistos(dias: int = 30) -> Optional[set]:
    ...
    CORREÇÃO (2026-05-03): Retorna None em caso de falha (distinto de set() vazio = sem histórico),
                           permitindo ao chamador acionar fallback para JSON local.
    """
    ...
    if resp is None or resp.status_code != 200:
        ...
        return None  # None = falha na leitura; set() vazio = sucesso sem histórico
    try:
